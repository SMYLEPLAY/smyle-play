...
class TradeOffer(Base):
    ...
    # target_type ∈ {playlist_adn, album_adn, visual_adn, profile_adn} —
    # String volontaire (pas d'enum DB) pour pouvoir ajouter un type sans
    # migration. sender = ACHETEUR, receiver = VENDEUR (créateur de l'ADN).
    # Colonnes déjà présentes en DB via migration 0080_adn_offers_reserve.
