  ...
  function open(opts) {
    ...
    ov.innerHTML =
      '<div class="pd-box" role="dialog" aria-modal="true" aria-label="Confirmer l’achat">' +
        ...
        // Chantier C (02/07) — teaser public de l'ADN (dna_description).
        // oeuvre.js le passait déjà (desc:) mais il n'était jamais rendu ;
        // bénéficie symétriquement aux drawers 'playlist' ET 'album-adn'.
